...
insert into `departments` values(41,'전자공학학과','051-510-1041');
...
insert into `professors` values('P11101','11','김관창','880529-1234567','010-1101-1989','kwanch@hg.ac.kr','대전');
insert into `professors` values('P11103','11','김춘추','780412-1234567','010-1101-1979','kimcc@hg.ac.kr','대전');
insert into `professors` values('P11104','11','이사부','650911-1234567','010-1101-1966','leesabu@hg.ac.kr','대전');
insert into `professors` values('P22110','22','장보고','780727-1234567','010-1101-1979','jangbg@hg.ac.kr','대구');
insert into `professors` values('P23102','23','선덕여왕','830614-1234567','010-1101-1984','gueen@hg.ac.kr','대구');
insert into `professors` values('P31101','31','강감찬','641020-1234567','010-1101-1965','kang@hg.ac.kr','대구');
insert into `professors` values('P31104','31','신사임당','711127-1234567','010-1101-1972','sinsa@hg.ac.kr','부산');
insert into `professors` values('P40101','40','이이','910906-1234567','010-1101-1992','leelee@hg.ac.kr','부산');
insert into `professors` values('P40102','40','이황','881208-1234567','010-1101-1989','hwang@hg.ac.kr','광주');
insert into `professors` values('P42103','42','송상현','760313-1234567','010-1101-1977','ssh@hg.ac.kr','광주');
...
insert into `student` values(20111011,10,'P11103','전지현','890530-1234567','010-1103-8905','jjh@naver.com','대전');
...
delete from `student` where `studentNum`= '20101101';

insert into `register`(`studNo`,`lecNo`,`proNo`) values('20101001', '101001','P10101');
insert into `register`(`studNo`,`lecNo`,`proNo`) values('20101001', '101002','P10102');
insert into `register`(`studNo`,`lecNo`,`proNo`) values('20111013', '111011','P11103');
insert into `register`(`studNo`,`lecNo`,`proNo`) values('21231002', '231110','P23102');
insert into `register`(`studNo`,`lecNo`,`proNo`) values('22401001', '401019','P40101');
insert into `register`(`studNo`,`lecNo`,`proNo`) values('22401001', '421012','P42103');
insert into `register`(`studNo`,`lecNo`,`proNo`) values('20101001', '101003','P10102');
insert into `register`(`studNo`,`lecNo`,`proNo`) values('22421003', '311003','P31104');
insert into `register`(`studNo`,`lecNo`,`proNo`) values('22421003', '421012','P42103');
insert into `register`(`studNo`,`lecNo`,`proNo`) values('20111013', '111012','P11104');
