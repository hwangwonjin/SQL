...
insert into `departments` values('106','산부인과','신사인당','051-123-0106');
insert into `departments` values('107','흉부외과','류성룡','051-123-0107');
insert into `departments` values('108','정형과','송상현','051-123-0108');
insert into `departments` values('109','신경과','이순신','051-123-0109');
...
insert into `doctors` values('D103101','장보고','1979-07-28','M','103','과장','010-3101-1979','jangbu@bw.com');
insert into `doctors` values('D104101','선덕여왕','1984-06-15','F','104','과장','010-4101-1976','gueen@bw.com');
insert into `doctors` values('D105101','강감찬','1965-10-21','M','105','과장','010-5101-1976','kang@bw.com');
insert into `doctors` values('D106101','신사임당','1972-11-28','F','106','과장','010-6101-1976','sinsa@bw.com');
...
insert into `nurses` values('N105101','송혜교','1984-07-15','F','105','주임','010-4101-7908','song@bw.com');
...
insert into `patients` values('P108101','D108101','N108101','김연아','651021-1234567','F','대구','010-5101-6510','yuna@daum.com','운동선우');
