...
insert into `bank_account` values('101-12-1002','S2','정기적금예금','830513-1000003',1020000,'2011-05-13');
...
#실습2-15
select sum(`t_amount`) as `임금총합`, avg(`t_amount`) as `임금평균` from `bank_transaction` where `t_dist`=1;
