...
insert into `users` values('user10','허난설현','1992-09-07','F','010-7101-1992',null,4100,'3','광주','2022-01-10 10:50:12');

##포인트
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user1','1000','회원가입 1000 적립','2022-01-10 ');
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user1','6000','상품구매 5% 적립','2022-01-10 10:50:12');
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user3','6000','상품구매 5% 적립','2022-01-10 10:50:12');
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user7','6000','상품구매 5% 적립','2022-01-10 10:50:12');
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user5','6000','이벤트응모 3000 적립','2022-01-10 10:50:12');
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user2','6000','회원가입 1000 적립','2022-01-10 10:50:12');
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user2','6000','이벤트 응모 3000 적립','2022-01-10 10:50:12');
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user2','6000','상품구매 5% 적립','2022-01-10 10:50:12');
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user3','6000','이벤트 응모 3000 적립','2022-01-10 10:50:12');
insert into `points`(`userid`,`point`,`pointDesc`,`pointDate`) values('user6','6000','상품구매 2% 적립','2022-01-10 10:50:12');
...
insert into `products` values('100110','10','10004','트레이닝 통바지','869','25000','398','15');
insert into `products` values('110101','10','10003','신상 여성운동화','869','25000','40','5');
insert into `products` values('120101','12','10010','암소 1등급 구이셋트 1.2kg','869','25000','87','15');
insert into `products` values('120103','12','10010','바로구이 부채살 250g','869','25000','61','10');
insert into `products` values('130101','13','10006','[ANF] 식스프리 강아지 사료','869','25000','142','0');
insert into `products` values('130112','13','10006','중대형 사계절 강아지옷','869','25000','80','0');
insert into `products` values('140101','14','10001','라떼 2인 소파/방수 패브릭','869','25000','42','0');
insert into `products` values('170115','17','10007','지포스 3080 그래픽카드','869','25000','12','12');
insert into `products`(`prodNo`,`cateNo`,`sellerno`,`prodname`,`prodprice`,`prodstock`,`prodsold`) values('160103','16','10009','치닝디핑 33BR 철봉','32','120000','28');
